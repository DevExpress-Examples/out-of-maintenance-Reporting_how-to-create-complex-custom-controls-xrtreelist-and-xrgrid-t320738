...
Namespace DevExpress.XtraReports.CustomControls
	Friend Class XRTableLikeContainerControlPresenter
        ...
        Protected Shadows Sub CorrectBrickBounds(ByVal recordBrick As DataRecordBrick, ByVal childBricks As List(Of VisualBrick), ByVal indent As Single, ByVal actualHeight As Single)
            Dim recordHeight As Single = GraphicsUnitConverter.Convert(2.0F, GraphicsDpi.HundredthsOfAnInch, TableControl.Dpi)

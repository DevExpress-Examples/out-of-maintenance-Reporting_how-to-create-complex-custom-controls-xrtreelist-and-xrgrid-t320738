...
'INSTANT VB NOTE: The variable isHeader was renamed since Visual Basic does not allow variables and other class members to have the same name:
...
'INSTANT VB NOTE: The variable rect was renamed since Visual Basic does not handle local variables named the same as class members well:
				Dim rect_Renamed As RectangleF = page.GetBrickBounds(Me)
				isFirstPage = Not DirectCast(page, IPage).UsefulPageRectF.IntersectsWith(rect_Renamed)
			End If
...
'INSTANT VB NOTE: The variable isHeaderBrick was renamed since Visual Basic does not allow variables and other class members to have the same name:
...
'INSTANT VB NOTE: The variable cellPosition was renamed since Visual Basic does not allow variables and other class members to have the same name:

...
Namespace DevExpress.XtraReports.CustomControls
	Public Class XRDataContainerControlDesigner
		...
		Protected Overrides Function GetFilteredProperties() As String()
        ...
        Friend Shadows Sub OnCollectionChanged()
	...
	Public Class XRDataContainerDesignerDataActionList
		...
		#Region "Properties"
		<Editor(GetType(DataAdapterEditor), GetType(UITypeEditor)), TypeConverterAttribute(GetType(DataAdapterConverter))> _
		...
		<TypeConverter(GetType(DataMemberTypeConverter)), Editor(GetType(DataContainerDataMemberEditor), GetType(UITypeEditor)), RefreshProperties(RefreshProperties.All)> _
		...
		<Editor(GetType(DataSourceEditor), GetType(UITypeEditor)), TypeConverter(GetType(DataSourceConverter)), RefreshProperties(RefreshProperties.All)> _

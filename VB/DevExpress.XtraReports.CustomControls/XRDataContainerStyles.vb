...
Namespace DevExpress.XtraReports.CustomControls
	...
	Public Class XRDataContainerStyles
		...
		Public Overridable Property HeaderStyle() As XRControlStyle
			Get
				Return DirectCast(Me.control, XRDataContainerControl).HeaderStyleCore
			End Get
			Set(ByVal value As XRControlStyle)
				DirectCast(Me.control, XRDataContainerControl).HeaderStyleCore = value
			End Set
		End Property
		...
		Public Overridable Property EvenCellStyle() As XRControlStyle
			Get
				Return DirectCast(Me.control, XRDataContainerControl).EvenCellStyleCore
			End Get
			Set(ByVal value As XRControlStyle)
				DirectCast(Me.control, XRDataContainerControl).EvenCellStyleCore = value
			End Set
		End Property
		...
		Public Overridable Property OddCellStyle() As XRControlStyle
			Get
				Return DirectCast(Me.control, XRDataContainerControl).OddCellStyleCore
			End Get
			Set(ByVal value As XRControlStyle)
				DirectCast(Me.control, XRDataContainerControl).OddCellStyleCore = value
			End Set
		End Property
		...
		Public Overridable Property CellStyle() As XRControlStyle
			Get
				Return DirectCast(Me.control, XRDataContainerControl).CellStyleCore
			End Get
			Set(ByVal value As XRControlStyle)
				DirectCast(Me.control, XRDataContainerControl).CellStyleCore = value
			End Set
		End Property
	End Class
End Namespace

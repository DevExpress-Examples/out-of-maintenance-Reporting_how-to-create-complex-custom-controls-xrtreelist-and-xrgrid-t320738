...
'INSTANT VB NOTE: The variable nodeIndent was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private nodeIndent_Renamed As Integer

'INSTANT VB NOTE: The variable nodes was renamed since Visual Basic does not allow variables and other class members to have the same name:
		...
		Protected Overrides Function CreatePresenter() As Native.Presenters.ControlPresenter
			Return MyBase.CreatePresenter(Of ControlPresenter)(Function() New XRTreeListRuntimePresenter(Me), Function() New XRTreeListDesignTimePresenter(Me), Function() New XRTreeListDesignTimePresenter(Me))
		End Function
		...
		Protected Friend Overridable Sub OnPrintNode(ByVal e As PrintNodeEventArgs)
			Me.RunEventScript(Of PrintNodeEventArgs)(PrintNodeEvent, "PrintNode", e)
		...
		Protected Friend Overridable Sub OnPrintNodeCell(ByVal e As PrintNodeCellEventArgs)
			Me.RunEventScript(Of PrintNodeCellEventArgs)(PrintNodeCellEvent, "PrintNodeCell", e)
	...
	Public Class XRTreeListNode
		...
		#Region "Fields"
'INSTANT VB NOTE: The variable parentNode was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private parentNode_Renamed As XRTreeListNode
'INSTANT VB NOTE: The variable nodes was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private nodes_Renamed As XRTreeListNodeCollection
'INSTANT VB NOTE: The variable keyValue was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private keyValue_Renamed As Object
'INSTANT VB NOTE: The variable parentValue was renamed since Visual Basic does not allow variables and other class members to have the same name:
...
'INSTANT VB NOTE: The local variable level was renamed since Visual Basic will not allow local variables with the same name as their enclosing function or property:
	...
	Public Class PrintNodeEventArgs
		...
		#Region "Fields"
'INSTANT VB NOTE: The variable suppressType was renamed since Visual Basic does not allow variables and other class members to have the same name:

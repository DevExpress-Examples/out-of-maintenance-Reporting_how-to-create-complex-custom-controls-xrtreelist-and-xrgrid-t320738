...
Namespace DevExpress.XtraReports.CustomControls
	...
	Public Class XRTreeList
		...
		Private Shared ReadOnly PrintNodeEvent As Object = New Object()
		Private Shared ReadOnly PrintNodeCellEvent As Object = New Object()
	...
	Public Class XRTreeListNode
		...
		Public Overrides Function Compare(ByVal other As XRDataRecord) As Integer
			...
			If sortResult = 0 Then
				sortResult = Comparer.Default.Compare(Me.KeyValue, (CType(other, XRTreeListNode)).KeyValue)
			End If
			Return sortResult
		End Function
		#End Region

...
Namespace DevExpress.XtraReports.CustomControls
	...
	Public Class XRDataContainerControl
		...
		Private Shared ReadOnly PrintHeaderCellEvent As Object = New Object()
		Private Shared ReadOnly PrintRecordEvent As Object = New Object()
		Private Shared ReadOnly PrintRecordCellEvent As Object = New Object()
		#End Region
...
#Region "Methods"
        ...
        Protected Overrides Sub CollectAssociatedComponents(ByVal components As DesignItemList)
            ...
            components.AddDataSource(TryCast((CType(Me, IDataContainer)).GetSerializableDataSource(), IComponent))
            components.AddDataAdapter(Me.dataAdapter_Renamed)
        End Sub
        ...
        Private Function GetDataSource() As IList Implements ICustomDataContainer.GetDataSource
            Using context As New DataContext()
        ...
        Private Sub InitializeDefaultStyles()
            fDefaultCellStyle = New XRControlStyle(Color.Transparent, Color.Black, BorderSide.All, 1.0F, BrickStyle.DefaultFont, Color.Black, XtraPrinting.TextAlignment.MiddleLeft, New PaddingInfo(2, 2, 2, 2), XtraPrinting.BorderDashStyle.Solid)
            fDefaultHeaderStyle = New XRControlStyle(Color.LightGray, Color.Black, BorderSide.All, 1.0F, BrickStyle.DefaultFont, Color.Black, XtraPrinting.TextAlignment.MiddleCenter, New PaddingInfo(2, 2, 2, 2), XtraPrinting.BorderDashStyle.Solid)
        End Sub
...
#Region "Properties"
        ...
        <XtraSerializableProperty, DefaultValue(25.0F), RefreshProperties(RefreshProperties.All)> _
        ...
        <Editor(GetType(DataAdapterEditor), GetType(UITypeEditor)), TypeConverterAttribute(GetType(DataAdapterConverter)), System.ComponentModel.DefaultValue(GetType(Object), Nothing)> _
        ...
        <Editor(GetType(DataSourceEditor), GetType(UITypeEditor)), TypeConverter(GetType(DataSourceConverter)), RefreshProperties(RefreshProperties.All), System.ComponentModel.DefaultValue(GetType(Object), Nothing)> _
...
#End Region
	...
	Public Class XRFieldHeaderCollection
        ...
        Private Iterator Function IEnumerable_GetEnumerator() As IEnumerator(Of XRFieldHeader) Implements IEnumerable(Of XRFieldHeader).GetEnumerator
		...
		Public Function GetHeaderByFieldName(ByVal fieldName As String) As XRFieldHeader
			...
			For i As Integer = 0 To Me.Count - 1
				If (CType(Me.List(i), XRFieldHeader)).FieldName = fieldName Then
					header = CType(Me.List(i), XRFieldHeader)
					Exit For
				End If
			Next i
			Return header
		...
		Default Public Overridable ReadOnly Property Item(ByVal index As Integer) As XRFieldHeader
			Get
				Return CType(List(index), XRFieldHeader)
			End Get
		End Property
		#End Region
	End Class
	...
	Public Class XRFieldHeader
		...
		Private Function GetDataSource() As IList Implements ICustomDataContainer.GetDataSource
			Return (CType(Me.Owner.Control, ICustomDataContainer)).GetDataSource()
		End Function
		#End Region
	...
	Public Class XRDataRecord
		...
		Private Function CompareTo(ByVal other As XRDataRecord) As Integer Implements IComparable(Of XRDataRecord).CompareTo
	...
	Public Class XRSortFieldCollection
        ...
        Private Overloads Iterator Function GetEnumerator() As IEnumerator(Of XRSortField) Implements IEnumerable(Of XRSortField).GetEnumerator
		...
		Public Function GetFieldByFieldName(ByVal fieldName As String) As XRSortField
			...
			For i As Integer = 0 To Me.Count - 1
				If (CType(Me.List(i), XRSortField)).FieldName = fieldName Then
					field = CType(Me.List(i), XRSortField)
					Exit For
				End If
			Next i
			Return field
		...
		Default Public Overridable ReadOnly Property Item(ByVal index As Integer) As XRSortField
			Get
				Return CType(List(index), XRSortField)
			End Get
		End Property
		#End Region
	End Class

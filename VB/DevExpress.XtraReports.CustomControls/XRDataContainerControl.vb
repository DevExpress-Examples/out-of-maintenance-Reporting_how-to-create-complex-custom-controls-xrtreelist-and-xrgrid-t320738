...
Namespace DevExpress.XtraReports.CustomControls
	...
	Public Class XRDataContainerControl
		Inherits XRControl
		Implements IDataContainer, IDataContainerBase, ICustomDataContainer, ISupportInitialize

		#Region "Fields"
'INSTANT VB NOTE: The variable cellHeight was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private cellHeight_Renamed As Single
'INSTANT VB NOTE: The variable cellAutoHeight was renamed since Visual Basic does not allow variables and other class members to have the same name:
...
'INSTANT VB NOTE: The variable dataMember was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private dataMember_Renamed As String
'INSTANT VB NOTE: The variable dataAdapter was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private dataAdapter_Renamed As Object
		Friend isLoading As Boolean

'INSTANT VB NOTE: The variable headers was renamed since Visual Basic does not allow variables and other class members to have the same name:
...
'INSTANT VB NOTE: The variable sortFields was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private sortFields_Renamed As XRSortFieldCollection

'INSTANT VB NOTE: The variable evenCellStyleName was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private evenCellStyleName_Renamed As String
'INSTANT VB NOTE: The variable oddCellStyleName was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private oddCellStyleName_Renamed As String
'INSTANT VB NOTE: The variable cellStyleName was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private cellStyleName_Renamed As String
'INSTANT VB NOTE: The variable headerStyleName was renamed since Visual Basic does not allow variables and other class members to have the same name:
		...
		Public Shadows Custom Event Draw As DrawEventHandler
			...
			End RemoveHandler
			RaiseEvent(ByVal sender As System.Object, ByVal e As DevExpress.XtraReports.UI.DrawEventArgs)
			End RaiseEvent
		End Event
		<Browsable(False), EditorBrowsable(EditorBrowsableState.Never)>
		Public Shadows Custom Event EvaluateBinding As BindingEventHandler
			...
			End RemoveHandler
			RaiseEvent(ByVal sender As System.Object, ByVal e As DevExpress.XtraReports.UI.BindingEventArgs)
			End RaiseEvent
		End Event
		<Browsable(False), EditorBrowsable(EditorBrowsableState.Never)>
		Public Shadows Custom Event HtmlItemCreated As HtmlEventHandler
			...
			End RemoveHandler
			RaiseEvent(ByVal sender As System.Object, ByVal e As DevExpress.XtraReports.UI.HtmlEventArgs)
			End RaiseEvent
		End Event
		<Browsable(False), EditorBrowsable(EditorBrowsableState.Never)>
		Public Shadows Custom Event PreviewClick As PreviewMouseEventHandler
			...
			End RemoveHandler
			RaiseEvent(ByVal sender As System.Object, ByVal e As DevExpress.XtraReports.UI.PreviewMouseEventArgs)
			End RaiseEvent
		End Event
		<Browsable(False), EditorBrowsable(EditorBrowsableState.Never)>
		...
		Public Shadows Custom Event PrintOnPage As PrintOnPageEventHandler
			...
			End RemoveHandler
			RaiseEvent(ByVal sender As System.Object, ByVal e As DevExpress.XtraReports.UI.PrintOnPageEventArgs)
			End RaiseEvent
		End Event
		<Browsable(False), EditorBrowsable(EditorBrowsableState.Never)>
		...
		Protected Overrides Sub CollectAssociatedComponents(ByVal components As DesignItemList)
            ...
            components.AddDataComponents(Me)
		End Sub
...
'INSTANT VB NOTE: The variable band was renamed since Visual Basic does not handle local variables named the same as class members well:
			Dim band_Renamed As New DocumentBand(bandKind, 0)
			parentBand.Bands.Add(band_Renamed)
		...
		Protected Friend Overridable Sub OnPrintHeaderCell(ByVal e As PrintCellEventArgs)
			Me.RunEventScript(Of PrintCellEventArgs)(PrintHeaderCellEvent, "PrintHeaderCell", e)
		...
		Protected Friend Overridable Sub OnPrintRecord(ByVal e As PrintRecordEventArgs)
			Me.RunEventScript(Of PrintRecordEventArgs)(PrintRecordEvent, "PrintRecord", e)
		...
		Protected Friend Overridable Sub OnPrintRecordCell(ByVal e As PrintRecordCellEventArgs)
			Me.RunEventScript(Of PrintRecordCellEventArgs)(PrintRecordCellEvent, "PrintRecordCell", e)
        ...
        <TypeConverter(GetType(DataMemberTypeConverter)), Editor(GetType(DataContainerDataMemberEditor), GetType(UITypeEditor)), RefreshProperties(RefreshProperties.All), DefaultValue(""), XtraSerializableProperty(XtraSerializationVisibility.Reference)>
        Public Property DataMember() As String Implements DevExpress.Data.IDataContainerBase.DataMember
			Get
        ...
        Public Property DataSource() As Object Implements DevExpress.Data.IDataContainerBase.DataSource
			Get
				Return Me.dataSource_Renamed
			End Get
			Set(ByVal value As Object)
...
'INSTANT VB NOTE: The variable fieldName was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private fieldName_Renamed As String
'INSTANT VB NOTE: The variable fieldType was renamed since Visual Basic does not allow variables and other class members to have the same name:
...
'INSTANT VB NOTE: The variable control was renamed since Visual Basic does not allow variables and other class members to have the same name:
		...
		Default Public Property Item(ByVal fieldName As String) As Object
			Get
				Dim index As Integer = Control.Headers.GetHeaderIndexByFieldName(fieldName)
				Return Me(index)
			End Get
			Friend Set(ByVal value As Object)
				Dim index As Integer = Control.Headers.GetHeaderIndexByFieldName(fieldName)
...
'INSTANT VB NOTE: The variable sortOrder was renamed since Visual Basic does not allow variables and other class members to have the same name:
	...
	Public Class PrintCellEventArgs
		...
		#Region "Fields"
'INSTANT VB NOTE: The variable header was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private header_Renamed As XRFieldHeader
'INSTANT VB NOTE: The variable brick was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private brick_Renamed As VisualBrick
'INSTANT VB NOTE: The variable style was renamed since Visual Basic does not allow variables and other class members to have the same name:
	...
	Public Class PrintRecordEventArgs
		...
		#Region "Fields"
'INSTANT VB NOTE: The variable cancel was renamed since Visual Basic does not allow variables and other class members to have the same name:
		Private cancel_Renamed As Boolean
'INSTANT VB NOTE: The variable record was renamed since Visual Basic does not allow variables and other class members to have the same name:

...
Namespace DevExpress.XtraReports.CustomControls
	...
	Public Class XRGrid
		...
		Protected Overrides Function CreatePresenter() As Native.Presenters.ControlPresenter
			Return MyBase.CreatePresenter(Of ControlPresenter)(Function() New XRGridRuntimePresenter(Me), Function() New XRGridDesignTimePresenter(Me), Function() New XRGridDesignTimePresenter(Me))
		End Function
